...
cat("<div class='quarto-title-meta-heading'><i class='bi bi-file-earmark-text'></i> [Documentation](", uns$dataset_url, ")</div>\n", sep = "")

cat("<div class='quarto-title-meta-heading'><i class='bi bi-globe'></i> [Source](", uns$data_url, ")</div>\n", sep = "")
