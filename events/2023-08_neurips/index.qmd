...
description: |
  [See NeurIPS 2023 Competition Track](https://neurips.cc/Conferences/2023/CompetitionTrack){class="btn btn-primary" style="border: 1px solid white;"}
  [See on Kaggle](https://www.kaggle.com/competitions/open-problems-single-cell-perturbations){class="btn btn-primary" style="border: 1px solid white;"}
date: "2023-08-30"
