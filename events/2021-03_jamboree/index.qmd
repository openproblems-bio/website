...
subtitle: A virtual hackathon and kickoff event
description: |
    The Open Problems for Single-Cell Analysis project is a community effort to standardize benchmarking for single-cell analysis. We aim to hold a remote Jamboree in the Spring of 2021 to bring together and expand the Open Problems Community as we build a resource to drive innovation in single-cell analytics.
date: "2021-03-29"
...
1. Watch the [Open Problems Repository introduction video](https://www.youtube.com/watch?v=tHempZCdXyA)
2. Watch the [tutorial on adding a new task](https://www.youtube.com/watch?v=tgVG3Hp6mBc)
3. Read the guide for [GitHub and AWS SageMaker](https://github.com/openproblems-bio/openproblems/blob/master/SAGEMAKER.md) (video linked in guide)
...
3. Go through the [Hello World tutorial](https://guides.github.com/activities/hello-world/) on GitHub: 
4. Read through the CONTRIBUTING.md file that describes the process for adding code to the GitHub repository.
