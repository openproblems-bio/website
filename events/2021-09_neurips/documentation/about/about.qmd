...
The competitions is broken down into three tracks, each with an independent set of prizes. Details about each task can be found in the [Tasks Documentation](/events/2021-09_neurips/documentation/about_tasks).
...
Winners will receive a cash price according to the prize criteria described in each task description. [Terms and conditions](/events/2021-09_neurips/documentation/submission/terms.qmd) apply.

For more information about how to get started, visit our [Getting Started](/events/2021-09_neurips/documentation/about/getting_started.qmd) instructions.
