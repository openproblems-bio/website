...
Implement your method in `script.py` (or `script.R` for R users) and update the Viash config accordingly. The file format of the script and config are described in the [Starter kit contents](/events/2021-09_neurips/documentation/submission/starter_kit_contents.qmd) description.
...
If this process runs successfully, then you will be instructed to upload the submission to EvalAI. If you see any warnings, please consult our [FAQ](/events/2021-09_neurips/documentation/submission/faq.qmd).
...
## Troubleshooting
If you encounter any issues, please look at the [Frequently Asked Questions](/events/2021-09_neurips/documentation/submission/faq.qmd). If this doesn't solve your problem, visit the #support channel on Discord.