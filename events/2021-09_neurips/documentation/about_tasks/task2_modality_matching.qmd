...
The following section describes the task API for the Modality Matching task. Competitors must submit their code as a Viash component. To facilitate creation of these components, [starter kits](/events/2021-09_neurips/documentation/submission/starter_kit_contents.qmd) have been provided.

### Input data formats

:::{.callout-note}
The data format and attributes provided in the input data is tailored to each task and may differ from the publicly released [benchmarking dataset](/events/2021-09_neurips/documentation/data/dataset.qmd). **Only the attributes listed in the following section will be accessible to methods submitted to the competition.**
:::
...
Examples of how to load and process the data are contained in the [starter kits](/events/2021-09_neurips/documentation/submission/starter_kit_contents.qmd) for the respective programming language.
