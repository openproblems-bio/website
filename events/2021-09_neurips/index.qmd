...
description: |
  ...
  [See on EvalAI](https://eval.ai/web/challenges/challenge-page/1111/overview){class="btn btn-primary" target="blank" style="border: 1px solid white;"} 
  ...
  [Read the competition paper (ICML 2022)](https://proceedings.mlr.press/v176/lance22a.html){class="btn btn-secondary" target="blank" style="border: 1px solid white; font-size: 0.8rem; padding: 3px 10px;"}
