...
The `__merge__` field is used to merge another YAML into a Viash config. One of it's uses is in making sure that all of the components in a task has the same API.
