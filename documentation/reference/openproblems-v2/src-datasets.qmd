...
render_component("src/datasets/api/comp_dataset_loader.yaml")
render_file("src/datasets/api/anndata_raw.yaml")
render_component("src/datasets/api/comp_normalization.yaml")
render_file("src/datasets/api/anndata_normalized.yaml")
render_component("src/datasets/api/comp_processor_pca.yaml")
render_component("src/datasets/api/comp_processor_hvg.yaml")
render_component("src/datasets/api/comp_processor_knn.yaml")
render_file("src/datasets/api/anndata_common_dataset.yaml")
render_component("src/datasets/api/comp_processor_subset.yaml")
```
