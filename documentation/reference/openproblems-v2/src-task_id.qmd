...
- **Resource generation scripts** (`src/<task_id>/resources_scripts`): This folder contains scripts for generating benchmarking resources required for the task.

- **Test resource generation scripts** (`src/<task_id>/resources_test_scripts`): This folder contains scripts for generating test resources for the task.
