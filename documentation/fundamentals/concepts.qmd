...
OpenProblems tasks contain specifications for the required and optional slots in AnnData files. These specifications are defined in the `src/tasks/*/api/file_*.yaml`. For more information on how these specifications are formatted, see ["Design the API"](/documentation/create_task/design_api.qmd).
...
OpenProblems tasks contain specifications for the common config fields between the same component types. These specifications are defined in the `src/tasks/*/comp_*.yaml` files. For more information on how these specifications are formatted, see ["Design the API"](/documentation/create_task/design_api.qmd).
