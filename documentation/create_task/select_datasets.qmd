...
In this section, we'll create the Dataset processor component, which uses one of the pre-defined Common datasets to create the AnnData objects which get passed to the methods and metrics. 
...
# TODO: uncomment this when a method component has been added to your task
# Run one method
...
Having created the first test resources, you can now start creating method and metric components. We recommend creating one method component and then one metric component first, so you can use those components to generate the test resources needed for testing all of the components.