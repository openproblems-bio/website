...
Begin by creating a README file at `src/tasks/<task_id>/README.md` with the following sections.
...
Once you have completed your README and task info file, share it with the OpenProblems community for feedback and discussion by creating an issue on our [issue tracker](https://github.com/openproblems-bio/openproblems-v2/issues/). 
