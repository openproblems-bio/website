...
This collaborative process will help ensure that your task is well-defined, relevant, and compatible with the OpenProblems framework. Additionally, it informs others of your ongoing work in this area and establishes a foundation for potential collaboration. This [issue](https://github.com/openproblems-bio/openproblems-v2/issues/180) can be used as a guide.
