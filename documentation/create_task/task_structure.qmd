...
Before defining a new task in OpenProblems, it's important to understand the typical structure of an OpenProblems task (@fig-task-workflow).
...
This components processes a [Common dataset](/documentation/reference/openproblems-v2/src-datasets.qmd#file-format-common-dataset) into task-specific dataset objects. In supervised tasks, this component will usually output a solution, a training dataset and a test dataset. In unsupervised tasks, this component usually output a solution and a masked dataset.
