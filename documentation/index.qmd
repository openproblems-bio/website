...
svg.append("text").attr("x", 220).attr("y", 100).text("event").style("font-size", "15px").attr("alignment-baseline","middle")
svg.append("text").attr("x", 220).attr("y", 130).text("milestone").style("font-size", "15px").attr("alignment-baseline","middle")
svg.append("text").attr("x", 220).attr("y", 160).text("competition").style("font-size", "15px").attr("alignment-baseline","middle")
