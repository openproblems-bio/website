...
:::{.callout-note}
Unlike common AnnData objects, the X slot in the AnnData objects are typically not defined (`None` in Python, `NULL` in R). Instead, the raw counts and normalised expression data are defined as layers.
:::
