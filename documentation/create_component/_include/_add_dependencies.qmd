...
For your convenience we have created several base images that can be used for python or R scripts. These images can be found in the OpenProblems github repo [base_images](https://github.com/openproblems-bio/base_images).
...
* `ghcr.io/openproblems-bio/base_images/python`
  Base image for python scripts.

* `ghcr.io/openproblems-bio/base_images/r`
  Base image for R scripts.

* `ghcr.io/openproblems-bio/base_images/pytorch_nvidia`
  Base image for scripts that use pytorch with nvidia gpu support.

* `ghcr.io/openproblems-bio/base_images/tensorflow_nvidia`
