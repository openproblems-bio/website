...
If your component works, please [create a pull request](../more_information/create_pull_request.qmd). After your dataset loader has been merged into the main branch, it will be used to generate a common dataset. After the common datasets have been generated, it will be picked up by the task-specific dataset processors if it has all of the slots required by the task.