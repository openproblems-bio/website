...
:::{.callout-tip}
If you run into any other problems, please take a look at our [troubleshooting](../more_information/troubleshooting.qmd) page.
:::


1. Assertion error

An `AssertionError` occurs when something is not true. When this occurs look at the `assert ...` line to check what went wrong.
...
2. Python / R dependency does not exist
