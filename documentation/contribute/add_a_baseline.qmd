...
#| output: asis
out = 0
with open("src/label_projection/control_methods/my_method_r/config.vsh.yaml") as f:
  lines = f.readlines()
...
```{bash}
#| echo: false
viash run src/label_projection/control_methods/my_method/config.vsh.yaml -- ---setup cachedbuild
```
</details>
:::
...
#| output: asis
out = 0
with open("src/label_projection/control_methods/my_method/script.py") as f:
  lines = f.readlines()
...
#| output: asis
out = 0
with open("src/label_projection/control_methods/my_method_r/script.R") as f:
  lines = f.readlines()
