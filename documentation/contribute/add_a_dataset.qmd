...
For more parameter options, refer to @sec-parameters
...
The script must ensure that that the output anndata object has the format as described in @sec-format.
...
## Format of a raw dataset object {#sec-format}
