...
```{bash}
#| echo: false
viash run src/common/create_skeleton/config.vsh.yaml -- --task label_projection --type metric --name my_metric
```
...
```{bash}
#| echo: false
viash run src/common/create_skeleton/config.vsh.yaml -- --task label_projection --type metric --name my_metric_r --language r
```
...
#| output: asis
out = 1
with open("/home/kai/Documents/openroblems/website/documentation/_openproblems-v2/src/label_projection/metrics/my_metric/config.vsh.yaml") as f:
  lines = f.readlines()
...
2. `info` - Change the `pretty_name` field to the formatted text version of `my_metric`
...
#| output: asis
out = 0
with open("/home/kai/Documents/openroblems/website/documentation/_openproblems-v2/src/label_projection/metrics/my_metric_r/config.vsh.yaml") as f:
  lines = f.readlines()
...
```{bash}
#| echo: false
viash run src/label_projection/metrics/my_metric/config.vsh.yaml -- ---setup cachedbuild
```
</details>
:::
...
#| output: asis
out = 0
with open("/home/kai/Documents/openroblems/website/documentation/_openproblems-v2/src/label_projection/metrics/my_metric/script.py") as f:
  lines = f.readlines()
...
#| output: asis
out = 0
with open("/home/kai/Documents/openroblems/website/documentation/_openproblems-v2/src/label_projection/metrics/my_metric_r/script.R") as f:
  lines = f.readlines()
...
```bash
viash test src/label_projection/metrics/my_method/config.vsh.yaml
```
<details>
  <summary>Output</summary>
```{bash}
