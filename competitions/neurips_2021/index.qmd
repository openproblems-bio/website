...
1.  Read [about the tasks](/competitions/neurips_2021_docs/about_tasks) and the [submission quickstart](/competitions/neurips_2021_docs/submission/quickstart/) on our competition website
2.  View the [starter kit contents](/competitions/neurips_2021_docs/submission/starter_kit_contents)
4.  Explore the data and prototype methods for free on [Saturn Cloud](https://openproblems.bio/competitions/neurips_2021_docs/about/explore) (Optional)
5.  Implement your method and [generate a submission](/competitions/neurips_2021_docs/submission/development_process/)!

Full details about all the above can be found in the [Competition Documentation](/competitions/neurips_2021_docs).
