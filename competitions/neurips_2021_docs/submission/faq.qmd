...
For more information, see [Updating the Configuration](/competitions/neurips_2021_docs/submission/starter_kit_contents.qmd#updating-the-configuration).
...
Yes. Please follow [these instructions](/competitions/neurips_2021_docs/submission/quickstart_saturncloud.qmd) to get started.