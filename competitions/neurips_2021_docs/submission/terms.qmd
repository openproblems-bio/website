...
This Challenge is a skills-based competition to promote and further the field of single-cell data science. In order to participate, you must follow all instructions and requirements posted on the Website page titled ["Development process"](/competitions/neurips_2021_docs/submission/development_process.qmd).
